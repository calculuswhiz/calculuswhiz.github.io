...
function pitchToFreq(pitch) {
    var _a;
    const [_, base, octave] = (_a = pitch.match(/(.+)(\d+)/)) !== null && _a !== void 0 ? _a : [];
    if (base == null)
        return null;
...
"use strict";
module.exports = JSON.parse('{"C":16.35,"Db":17.32,"C#":17.32,"D":18.35,"Eb":19.45,"D#":19.45,"E":20.6,"F":21.83,"Gb":23.12,"F#":23.12,"G":24.5,"Ab":25.96,"G#":25.96,"A":27.5,"Bb":29.14,"A#":29.14,"B":30.87}');
