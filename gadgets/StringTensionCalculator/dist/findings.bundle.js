...
function valueToTableData(value) {
    ...
    return [
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('<td>').text(b.toPrecision(4)),
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('<td>').text(rSq)
    ];
}
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => __awaiter(void 0, void 0, void 0, function* () {
    const converter = new (showdown__WEBPACK_IMPORTED_MODULE_1___default().Converter)({
        tables: true,
        tablesHeaderId: true
    });
    ...
    for (const value of materialEntries) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pre-table-1 + table tbody')
